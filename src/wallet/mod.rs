...
//                     let (exp_desc, _) = make_desc(&secp,
// network).map_err(LoadError::Descriptor)?;                     return
// Err(LoadError::Mismatch(LoadMismatch::Descriptor {                         keychain:
// KeychainKind::Internal,                        loaded: None,
//                         expected: Some(exp_desc),
//                     }));
//                 }
//             }
