    ...
    K: Clone + Debug + Ord,
{
    ...
    // TODO PR #318: We had renamed this method `Wallet::index` in prior iterations of the PR. I
    //               removed this here but would need to make sure it wasn't done for a good reason
