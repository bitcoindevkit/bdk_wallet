...
// )?; /// let mut wallet = Wallet::create(Bip44(key.clone(), KeychainKind::External), Bip44(key,
// KeychainKind::Internal)) ///     .network(Network::Testnet)
// ///     .create_wallet_no_persist()?;
// ///
// /// assert_eq!(wallet.next_unused_address(KeychainKind::External).to_string(),
// "mmogjc7HJEZkrLqyQYqJmxUqFaC7i4uf89"); /// assert_eq!(wallet.
// public_descriptor(KeychainKind::External).to_string(),
// "pkh([c55b303f/44'/1'/0'
// ]tpubDCuorCpzvYS2LCD75BR46KHE8GdDeg1wsAgNZeNr6DaB5gQK1o14uErKwKLuFmeemkQ6N2m3rNgvctdJLyr7nwu2yia7413Hhg8WWE44cgT/
// 0/*)#5wrnv0xt"); /// # Ok::<_, Box<dyn std::error::Error>>(())
// /// ```
// #[derive(Debug, Clone)]
...
// ///
// /// let key =
// bitcoin::bip32::Xpub::from_str("
// tpubDDDzQ31JkZB7VxUr9bjvBivDdqoFLrDPyLWtLapArAi51ftfmCb2DPxwLQzX65iNcXz1DGaVvyvo6JQ6rTU73r2gqdEo8uov9QKRb7nKCSU"
...
// ///
// /// assert_eq!(wallet.next_unused_address(KeychainKind::External).to_string(),
// "miNG7dJTzJqNbFS19svRdTCisC65dsubtR"); /// assert_eq!(wallet.
// public_descriptor(KeychainKind::External).to_string(),
// "pkh([c55b303f/44'/1'/0'
// ]tpubDDDzQ31JkZB7VxUr9bjvBivDdqoFLrDPyLWtLapArAi51ftfmCb2DPxwLQzX65iNcXz1DGaVvyvo6JQ6rTU73r2gqdEo8uov9QKRb7nKCSU/
// 0/*)#cfhumdqz"); /// # Ok::<_, Box<dyn std::error::Error>>(())
// /// ```
// #[derive(Debug, Clone)]
...
// ///
// /// assert_eq!(wallet.next_unused_address(KeychainKind::External).to_string(),
// "2N4zkWAoGdUv4NXhSsU8DvS5MB36T8nKHEB"); /// assert_eq!(wallet.
// public_descriptor(KeychainKind::External).to_string(),
// "sh(wpkh([c55b303f/49'/1'/0'
// ]tpubDDYr4kdnZgjjShzYNjZUZXUUtpXaofdkMaipyS8ThEh45qFmhT4hKYways7UXmg6V7het1QiFo9kf4kYUXyDvV4rHEyvSpys9pjCB3pukxi/
// 0/*))#s9vxlc8e"); /// # Ok::<_, Box<dyn std::error::Error>>(())
// /// ```
// #[derive(Debug, Clone)]
...
// /// let key =
// bitcoin::bip32::Xpub::from_str("
// tpubDC49r947KGK52X5rBWS4BLs5m9SRY3pYHnvRrm7HcybZ3BfdEsGFyzCMzayi1u58eT82ZeyFZwH7DD6Q83E3fM9CpfMtmnTygnLfP59jL9L"
// )?; /// let fingerprint = bitcoin::bip32::Fingerprint::from_str("c55b303f")?;
// /// let mut wallet = Wallet::create(
...
// ///
// /// assert_eq!(wallet.next_unused_address(KeychainKind::External).to_string(),
// "2N3K4xbVAHoiTQSwxkZjWDfKoNC27pLkYnt"); /// assert_eq!(wallet.
// public_descriptor(KeychainKind::External).to_string(),
// "sh(wpkh([c55b303f/49'/1'/0'
// ]tpubDC49r947KGK52X5rBWS4BLs5m9SRY3pYHnvRrm7HcybZ3BfdEsGFyzCMzayi1u58eT82ZeyFZwH7DD6Q83E3fM9CpfMtmnTygnLfP59jL9L/
// 0/*))#3tka9g0q"); /// # Ok::<_, Box<dyn std::error::Error>>(())
// /// ```
// #[derive(Debug, Clone)]
// pub struct Bip49Public<K: DerivableKey<Segwitv0>>(pub K, pub bip32::Fingerprint, pub
// KeychainKind);
...
// ///
// /// assert_eq!(wallet.next_unused_address(KeychainKind::External).to_string(),
// "tb1qhl85z42h7r4su5u37rvvw0gk8j2t3n9y7zsg4n"); /// assert_eq!(wallet.
// public_descriptor(KeychainKind::External).to_string(),
// "wpkh([c55b303f/84'/1'/0'
// ]tpubDDc5mum24DekpNw92t6fHGp8Gr2JjF9J7i4TZBtN6Vp8xpAULG5CFaKsfugWa5imhrQQUZKXe261asP5koDHo5bs3qNTmf3U3o4v9SaB8gg/
// 0/*)#6kfecsmr"); /// # Ok::<_, Box<dyn std::error::Error>>(())
// /// ```
// #[derive(Debug, Clone)]
...
// ///
// /// assert_eq!(wallet.next_unused_address(KeychainKind::External).to_string(),
// "tb1qedg9fdlf8cnnqfd5mks6uz5w4kgpk2pr6y4qc7"); /// assert_eq!(wallet.
// public_descriptor(KeychainKind::External).to_string(),
// "wpkh([c55b303f/84'/1'/0'
// ]tpubDC2Qwo2TFsaNC4ju8nrUJ9mqVT3eSgdmy1yPqhgkjwmke3PRXutNGRYAUo6RCHTcVQaDR3ohNU9we59brGHuEKPvH1ags2nevW5opEE9Z5Q/
// 0/*)#dhu402yv"); /// # Ok::<_, Box<dyn std::error::Error>>(())
// /// ```
// #[derive(Debug, Clone)]
// pub struct Bip84Public<K: DerivableKey<Segwitv0>>(pub K, pub bip32::Fingerprint, pub
// KeychainKind);
...
// ///
// /// assert_eq!(wallet.next_unused_address(KeychainKind::External).to_string(),
// "tb1p5unlj09djx8xsjwe97269kqtxqpwpu2epeskgqjfk4lnf69v4tnqpp35qu"); /// assert_eq!(wallet.
// public_descriptor(KeychainKind::External).to_string(),
// "tr([c55b303f/86'/1'/0'
// ]tpubDCiHofpEs47kx358bPdJmTZHmCDqQ8qw32upCSxHrSEdeeBs2T5Mq6QMB2ukeMqhNBiyhosBvJErteVhfURPGXPv3qLJPw5MVpHUewsbP2m/
// 0/*)#dkgvr5hm"); /// # Ok::<_, Box<dyn std::error::Error>>(())
// /// ```
// #[derive(Debug, Clone)]
...
// ///
// /// assert_eq!(wallet.next_unused_address(KeychainKind::External).to_string(),
// "tb1pwjp9f2k5n0xq73ecuu0c5njvgqr3vkh7yaylmpqvsuuaafymh0msvcmh37"); /// assert_eq!(wallet.
// public_descriptor(KeychainKind::External).to_string(),
// "tr([c55b303f/86'/1'/0'
// ]tpubDC2Qwo2TFsaNC4ju8nrUJ9mqVT3eSgdmy1yPqhgkjwmke3PRXutNGRYAUo6RCHTcVQaDR3ohNU9we59brGHuEKPvH1ags2nevW5opEE9Z5Q/
// 0/*)#2p65srku"); /// # Ok::<_, Box<dyn std::error::Error>>(())
// /// ```
// #[derive(Debug, Clone)]
...
mod test {
    ...
    // let xprvkey =
    // bitcoin::bip32::Xpriv::from_str("
    // xprv9s21ZrQH143K2fpbqApQL69a4oKdGVnVN52R82Ft7d1pSqgKmajF62acJo3aMszZb6qQ22QsVECSFxvf9uyxFUvFYQMq3QbtwtRSMjLAhMf"
    // ).unwrap(); assert!(xprvkey.network.is_mainnet());
    ...
    // ).unwrap(); assert!(!tprvkey.network.is_mainnet());
    ...
    // bitcoin::bip32::Xpub::from_str("
    // tpubDDDzQ31JkZB7VxUr9bjvBivDdqoFLrDPyLWtLapArAi51ftfmCb2DPxwLQzX65iNcXz1DGaVvyvo6JQ6rTU73r2gqdEo8uov9QKRb7nKCSU"
    // ).unwrap();     let fingerprint =
    // bitcoin::bip32::Fingerprint::from_str("c55b303f").unwrap();     check(
    ...
    // ).unwrap();     let fingerprint =
    // bitcoin::bip32::Fingerprint::from_str("73c5da0a").unwrap();     check(
