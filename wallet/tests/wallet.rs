...
//     ($psbt:expr, $fees:expr, $fee_rate:expr $( ,@dust_change $( $dust_change:expr )* )* $(
// ,@add_signature $( $add_signature:expr )* )* ) => ({         let psbt = $psbt.clone();
//         #[allow(unused_mut)]
...
//             $( $add_signature )*
//                 for txin in &mut tx.input {
//                     txin.script_sig = ScriptBuf::from_bytes([0x00;
// P2PKH_FAKE_SCRIPT_SIG_SIZE].to_vec()); // fake signature                 }
//         )*
...
//     let (mut wallet, _) =
// get_funded_wallet_single("wsh(or_d(pk(cRjo6jqfVNP33HhSS76UhXETZsGTZYx8FMFvR9kpbtCSV1PmdZdu),
// or_i(and_v(v:pkh(cVpPVruEDdmutPzisEsYvtST1usBR3ntr8pXSyt6D2YYqXRyPcFW),older(30)),and_v(v:
...
//     use bitcoin::bip32;
//     let (mut wallet, _) =
// get_funded_wallet_single("wpkh([73756c7f/48'/0'/0'/2'
...
// bip32::Xpub::from_str("
// tpubDCKxNyM3bLgbEX13Mcd8mYxbVg9ajDkWXMh29hMWBurKfVmBfWAM96QVP3zaUcN51HvkZ3ar4VwP82kC8JZhhux8vFQoJintSpVBwpFvyU3"
// ).unwrap();     let fingerprint = bip32::Fingerprint::from_hex("73756c7f").unwrap();
...
//     assert!(
//         matches!(res, Err(CalculateFeeError::MissingTxOut(outpoints)) if outpoints[0] ==
// utxo.outpoint)     );
// }
...
//             "psbt_input with just witness_utxo should succeed when `only_witness_utxo` is
// enabled"         );
//     }
...
//     let key =
// bip32::Xpub::from_str("
// tpubD6NzVbkrYhZ4Y55A58Gv9RSNF5hy84b5AJqYy7sCcjFrkcLpPre8kmgfit6kY1Zs3BLgeypTDBZJM222guPpdz7Cup5yzaMu62u7mYGbwFL"
// ).unwrap();     let fingerprint = bip32::Fingerprint::from_hex("997a323b").unwrap();
...
//     // + input satisfaction weight: 112 WU = 106 (witness) + 2 (witness len) + (1 (script len)) *
// 4     // - change output weight: 124 WU = (8 (value) + 1 (script len) + 22 (script)) * 4
//     let new_tx_weight =
...
//     assert_fee_rate!(psbt, fee, FeeRate::from_sat_per_vb_unchecked(140), @dust_change,
// @add_signature); }
...
//     let (mut wallet, _) =
// get_funded_wallet_single("wpkh([d34db33f/84h/1h/
// 0h]tprv8ZgxMBicQKsPd3EupYiPRhaMooHKUHJxNsTfYuScep13go8QFfHdtkG9nRkFGb7busX4isf6X9dURGCoKgitaApQ6MupRhZMcELAxTBRJgS/
// *)");     let addr = wallet.next_unused_address(KeychainKind::External);
//     let mut builder = wallet.build_tx();
//     builder.drain_to(addr.script_pubkey()).drain_wallet();
//     let mut psbt = builder.finish().unwrap();
...
// get_funded_wallet_single("
// wpkh(tprv8ZgxMBicQKsPd3EupYiPRhaMooHKUHJxNsTfYuScep13go8QFfHdtkG9nRkFGb7busX4isf6X9dURGCoKgitaApQ6MupRhZMcELAxTBRJgS/
// 44'/0'/0'/0/*)");     let addr = wallet.next_unused_address(KeychainKind::External);
//     let mut builder = wallet.build_tx();
//     builder.drain_to(addr.script_pubkey()).drain_wallet();
//     let mut psbt = builder.finish().unwrap();
...
//     let desc = get_test_wpkh();
//     let change_desc =
// "sh(wsh(multi(1,cVpPVruEDdmutPzisEsYvtST1usBR3ntr8pXSyt6D2YYqXRyPcFW,
// cRjo6jqfVNP33HhSS76UhXETZsGTZYx8FMFvR9kpbtCSV1PmdZdu)))";     let (mut wallet, _) =
// get_funded_wallet(desc, change_desc);     let addr =
// Address::from_str("2N1Ffz3WaNzbeLFBb51xyFMHYSEUXcbiSoX")         .unwrap()
//         .assume_checked();
//     let mut builder = wallet.build_tx();
//     builder
...
//         vec![
//
// (taproot::ControlBlock::decode(&Vec::<u8>::from_hex("
// c0b511bd5771e47ee27558b1765e87b541668304ec567721c7b880edc0a010da55b7ef769a745e625ed4b9a4982a4dc08274c59187e73e6f07171108f455081cb2"
// ).unwrap()).unwrap(),
// (ScriptBuf::from_hex("208aee2b8120a5f157f1223f72b5e62b825831a27a9fdf427db7cc697494d4a642ac").
// unwrap(), taproot::LeafVersion::TapScript)),
// (taproot::ControlBlock::decode(&Vec::<u8>::from_hex("
// c0b511bd5771e47ee27558b1765e87b541668304ec567721c7b880edc0a010da55b9a515f7be31a70186e3c5937ee4a70cc4b4e1efe876c1d38e408222ffc64834"
// ).unwrap()).unwrap(),
// (ScriptBuf::from_hex("2051494dc22e24a32fe9dcfbd7e85faf345fa1df296fb49d156e859ef345201295ac").
// unwrap(), taproot::LeafVersion::TapScript)),         ],
//     );
//     assert_eq!(
...
//     let tap_tree: bitcoin::taproot::TapTree =
// serde_json::from_str(r#"[1,{"Script":["
// 2051494dc22e24a32fe9dcfbd7e85faf345fa1df296fb49d156e859ef345201295ac",192]},1,{"Script":["
// 208aee2b8120a5f157f1223f72b5e62b825831a27a9fdf427db7cc697494d4a642ac",192]}]"#).unwrap();
...
//                 SignOptions {
//                     tap_leaves_options:
// TapLeavesOptions::Include(included_script_leaves.clone()),
// ..Default::default()                 },
//             )
//             .unwrap(),
//         "Unable to finalize tx"
...
//                 SignOptions {
//                     tap_leaves_options:
// TapLeavesOptions::Exclude(excluded_script_leaves.clone()),
// ..Default::default()                 },
//             )
//             .unwrap(),
//         "Unable to finalize tx"
...
//     // NOTE: A transaction spending an output coming from the coinbase tx at height h, is
// eligible     // to be included in block h + [100 = COINBASE_MATURITY] or higher.
//     // Tx elibible to be included in the next block will be accepted in the mempool, used in
// block     // templates and relayed on the network.
//     // Miners may include such tx in a block when their chaintip is at h + [99 =
// COINBASE_MATURITY -     // 1]. This means these coins are available for selection at height h +
// 99. // // By https://bitcoin.stackexchange.com/a/119017 let not_yet_mature_time =
//     confirmation_height + COINBASE_MATURITY - 2; let maturity_time = confirmation_height +
//     COINBASE_MATURITY - 1;
...
//     let (other_external_desc, other_internal_desc) =
// get_test_tr_single_sig_xprv_and_change_desc();     let (other_wallet, other_txid) =
// get_funded_wallet(other_internal_desc, other_external_desc);     let test_wallet_update = Update
