...
//         let descriptor = wallet.default_descriptor().to_string_with_secret(
//             &wallet
...
//         let internal_did = wallet.default_change_did();

//         let change_descriptor = {
//             let descriptor = wallet
//                 .public_descriptor(internal_did)
...
// "{\"descriptor\":\"
// wpkh(xprv9s21ZrQH143K4CTb63EaMxja1YiTnSEWKMbn23uoEnAzxjdUJRQkazCAtzxGm4LSoTSVTptoV9RbchnKPW9HxKtZumdyxyikZFDLhogJ5Uj/
// 44\'/0\'/0\'/0/*)\",\"blockheight\":5000,\"label\":\"Test Label\"}";         let export =
// FullyNodedExport::from_str(import_str).unwrap();
